...
class Config(object):
    ...
    # Put MongoDB URL
    DATABASE_URL = get_config("DATABASE_URL", "mongodb+srv://abirhasan2005:abirhasan@cluster0.oiscb.mongodb.net/cluster0?retryWrites=true&w=majority")
